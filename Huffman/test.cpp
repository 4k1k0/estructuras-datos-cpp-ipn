...
string tests[] = {
    "Yo digo que al chile entregues esto solo cambiando el nombre de las variables y poniendo el codigo en varios archivos, cambiando los printf por couts y asi."
};
